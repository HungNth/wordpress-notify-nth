...
class Message_Formatter {
	 ...
	 * @return string
	 */
	public function build_payment_complete_message( \WC_Order $order ): string {
		$message = $this->format_header( '✅ ' . __( 'PAYMENT COMPLETED', 'nth-notifications' ) );
		$message .= "\n\n";
		...
		return apply_filters( 'nth_notifications_payment_complete_message', $message, $order, $this->format_type );
	}
